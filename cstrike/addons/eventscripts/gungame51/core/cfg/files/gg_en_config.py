...
def load():
    ...
    config.text('   1 = Allow attackers to level up with AFK kills when on ' +
                'knife level.')
    config.text('Default Value: 0')
    config.cvar('gg_allow_afk_levels_knife', 0, 'Allow attackers to level up with ' +
                'AFK kills when on knife level.')
    ...
    config.text('   1 = Allow attackers to level up with AFK kills when on ' +
                'HeGrenade level.')
    config.text('Default Value: 0')
    config.cvar('gg_allow_afk_levels_nade', 0, 'Allow attackers to level up with ' +
                'AFK kills when on HEGrenade level.')
