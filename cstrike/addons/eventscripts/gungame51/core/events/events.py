...
class GG_LevelUp(ESEvent):
    ...
    attacker = ShortField(min_value=2, comment='The userid of the ' +
                               'player that leveled up')
    leveler = ShortField(min_value=2, comment='The userid of the ' +
                              'player that is leveling up')
    userid = ShortField(min_value=0, comment='The userid of victim')
    old_level = ByteField(min_value=1, comment='The old level of the ' +
                               'player that leveled up')
    new_level = ByteField(min_value=1, comment='The new level of the ' +
                               'player that leveled up')
...
class GG_LevelDown(ESEvent):
    ...
    attacker = ShortField(min_value=0, comment='The userid of the ' +
                               'player that is leveling down')
    leveler = ShortField(min_value=2, comment='The userid of the ' +
                              'player that is leveling down')
    userid = ShortField(min_value=2, comment='The userid of attacker')
    old_level = ByteField(min_value=1, comment='The old level of the ' +
                               'player that leveled down')
    new_level = ByteField(min_value=1, comment='The new level of the ' +
                               'player that leveled down')
...
class GG_Knife_Steal(ESEvent):
    ...
    attacker_level = ByteField(min_value=1, comment='The new level of ' +
                                    'the player that stole the level')
...
class GG_Multi_Level(ESEvent):
    ...
    userid = ShortField(min_value=2, comment='The userid of the player ' +
                             'that multi leveled')
...
class GG_New_Leader(ESEvent):
    ...
    userid = ShortField(min_value=2, comment='The userid of the player ' +
                             'that became the new leader')
    leveler = ShortField(min_value=2, comment='The userid of the player' +
                              ' that leveled up to become the new leader')
    leaders = StringField(comment='String of current leaders\' userids ' +
                               'separated by "," e.g. "2,7,9"')
    old_leaders = StringField(comment='String of old userids separated ' +
                                   'by "," e.g. "2,7,9"')
...
class GG_Tied_Leader(ESEvent):
    ...
    userid = ShortField(min_value=2, comment='The userid of the player ' +
                             'that tied the leader(s)')
    leveler = ShortField(min_value=2, comment='The userid of the player' +
                              ' that leveled up to tie the leader(s)')
    leaders = StringField(comment='String of current leaders\' userids ' +
                               'separated by "," e.g. "2,7,9"')
    old_leaders = StringField(comment='String of old userids separated ' +
                                   'by "," e.g. "2,7,9"')
...
class GG_Leader_LostLevel(ESEvent):
    ...
    userid = ShortField(min_value=2, comment='The userid of the leader ' +
                             'that lost a level')
    leveler = ShortField(min_value=2, comment='The userid of the player' +
                              ' that is leveling')
    leaders = StringField(comment='String of current leaders\' userids ' +
...
class GG_Win(ESEvent):
    ...
    attacker = ShortField(min_value=2, comment='The userid of the ' +
                               'player that won')
    winner = ShortField(min_value=2, comment='The userid of the ' +
                               'player that won')
    userid = ShortField(min_value=2, comment='The userid of the victim ' +
                             'that "gave up" the win')
    loser = ShortField(min_value=2, comment='The userid of the victim ' +
                             'that "gave up" the win')
    round = BooleanField(comment='1 if the winner of the round, 0 if ' +
...
class GG_Addon_Loaded(ESEvent):
    ...
    type = StringField(comment='The type of addon that was loaded ' +
                            '(included or custom)')
